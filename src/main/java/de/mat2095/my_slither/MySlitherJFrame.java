...
final class MySlitherJFrame extends JFrame {
    ...
    public static String chosenColour;
    ...
    String getSelectedColour() {
        return SNAKES[snake.getSelectedIndex()]; //gets the JComboBox selected number & gets the string version of that colour
    }

    void onOpen() {
        switch (status) {
            case CONNECTING:
                chosenColour = getSelectedColour();
